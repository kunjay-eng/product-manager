...
function getSummaryData() {
  try {
    ...
    const cashBal = { thb: d.cashTHB, usd: d.cashUSD, total: d.cashTotal };

    const feeUS = _getFeeUS();
    const feeTH = _getFeeTH();
    const feeTotalTHB = feeTH + feeUS * fx;

    const fxGainLossTHB = (d.totalUSDIn * fx) - d.exchangeTHB;
    ...
    return {
     ...
     th:   {
        valueTHB: d.thPortTHB,  unrealTHB: d.thUnrealTHB, realTHB: d.thRealTHB,
        divTHB: d.divTHB, feeTHB: feeTH
      },
      us:   {
        valueUSD: d.usPortUSD,  valueTHB: d.usPortTHB, unrealUSD: d.usUnrealUSD, unrealTHB: d.usUnrealTHB, realUSD: d.usRealUSD, realTHB: d.usRealTHB,
        divUSD: d.divUSD, divTHB: d.divUSD * fx, feeUSD: feeUS, feeTHB: feeUS * fx
      },



      fund: { valueTHB: d.fundPortTHB, unrealTHB: d.fundUnrealTHB, realTHB: d.fundRealTHB }, // ✅
